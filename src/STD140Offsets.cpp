...
vector<size_t> STD140Offsets::_AddArray(const string& name, size_t arraySize, size_t baseAligement, size_t baseOffset, const ValueType* typeTemplate)
{
...
vector<string> STD140Offsets::GetNames() const
{
